...
# Load VAD model and specify the hubconf file directory
...
# Initialize pipelines with local model paths
...
def process_audio_file(audio_file):
    ...
    # Add the overall emotion result to the first line of the JSON result
    results.append({
        "Overall Emotion": best_overall_emotion
    })

    # Perform VAD segmentation on the audio and recognize each segment
    ...
    # Delete the sub-audio files in the results folder
...
# Serve the React front-end application static files to the client
@app.route('/')
def serve():
